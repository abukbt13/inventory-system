	  ...
	  <div class="row">
		...
		<h1 class="my-4"></h1>
			<div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
			  ...
			  <a class="nav-link" id="v-pills-purchase-tab" data-toggle="pill" href="customer/purchase.php" role="tab" aria-controls="v-pills-purchase" aria-selected="false">Purchase</a>
			  ...
			  <a class="nav-link" id="v-pills-sale-tab" data-toggle="pill" href="customer/sales.php" role="tab" aria-controls="v-pills-sale" aria-selected="false">Sale</a>
			  ...
			  <a class="nav-link" id="v-pills-reports-tab" data-toggle="pill" href="customer/reports.php" role="tab" aria-controls="v-pills-reports" aria-selected="false">Reports</a>
			</div>
		</div>
		 <div class="col-lg-10">
...
//                          session_start();
                          if(isset($_SESSION['purchase'])){
                              ?>
                              <div>
                                  <p class="text-white bg-danger btn-danger p-2"><?php echo $_SESSION['purchase']; ?> ?</p>
                              </div>
                              <?php
